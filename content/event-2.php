<div id="section-event2" class="section">
	...
	<div class="margin-container">
		<div class="event-container">
			<div class="event-card">
				<img class="event-card-image" src="img/content/event_2_320x200.jpg" alt="Event Image">
				<div class="event-card-text-container">
    			<h4>The Player of Games Meetup</h4>
    			<div class="event-card-content-big">
	    			<p class="event-card-text-paragraph">Let's meet and talk about games! 
...
Let's follow up on the success of our latest annual get together with this, the first of what we hope will be a whole bunch of regular meet ups. 



We strongly encourage anyone with a passion for game development and culture to join us, whether you've been to our annual events or not. This is going to be fun!  </p> 
	    			<div class="event-card-image-big">
	    				<img class="event-card-image-big-img" src="img/content/event_2_320x200.jpg" alt="Event Image">
	    			</div>
    			</div>
  			</div>
  			<div class="event-card-content-time-container">
	  			<div class="event-card-content-time">
	  				...
	  				<div class="event-card-content-time-text">Friday 10 June 18:30-22:00</div>
					</div>
